...
class EarthquakeGraphic extends StatefulWidget {
  @override
  State<EarthquakeGraphic> createState() => _EarthquakeGraphicState();
}

class _EarthquakeGraphicState extends State<EarthquakeGraphic> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Aylara Göre Deprem Sayıları'),
